...
<body style="height: 833px;">
	<meta name="viewport" content="width=device-width, hright=device-height, target-densitydpi=device-dpi, initial-scale=1, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0">
	...
	.footerId .show-voice {
		background: url("http://i1.fuimg.com/671218/3297bf260679b26d.png")
			no-repeat;
		background-size: 100%;
		width: 0.6rem;
		height: 0.6rem;
	...
	.footerId .show-plus {
		background: url("http://i1.fuimg.com/671218/594fec48ef1bff58.png")
			no-repeat;
		background-size: 100%;
		width: 0.6rem;
		height: 0.6rem;
	...
	.footerId .show-smile {
		background: url("http://i1.fuimg.com/671218/5d7ede0e753bf759.png")
			no-repeat;
		background-size: 100%;
		width: 0.6rem;
		height: 0.6rem;
	...
	.three .avatar1 {
		background:
			url("http://wx2.sinaimg.cn/mw690/8d9179f0gy1fxy2d6nxbjj20b40b4gm0.jpg")
			no-repeat;
	}	
	.three .avatar2 {
		background:
			url("http://wx3.sinaimg.cn/mw690/007bcsg1gy1fy7drvlx1nj30b40b4q3u.jpg")
			no-repeat;
	}	
	.three .avatar3 {
		background:
			url("http://wx4.sinaimg.cn/mw690/8d9179f0gy1fxy2d6xks5j20b40b4q38.jpg")
			no-repeat;
	}	
	.three .avatar4 {
		background:
			url("http://wx2.sinaimg.cn/mw690/8d9179f0gy1fxy2dbk4hfj20b40b4gpg.jpg")
			no-repeat;
	}	
	.three .avatar5 {
		background:
			url("http://wx2.sinaimg.cn/mw690/8d9179f0gy1fxy2d987z5j20b40b4t93.jpg")
			no-repeat;
	}	
	.three .avatar6 {
		background:
			url("http://wx2.sinaimg.cn/small/8d9179f0gy1fxy2dc6ks5j208c08c0sr.jpg")
			no-repeat;
	}	
	.three .box-left {
		float: left;
	...
	.three .box-group1 {
		background:
			url(http://wx2.sinaimg.cn/mw690/007bcsg1gy1fy7duyiezuj30ao073gme.jpg)
			no-repeat;
	...
	.three .box-group2 {
		background: url('http://i2.tiimg.com/671218/257ca8d4a4bcd3fc.png')
			no-repeat;
		background-size: contain;
		width: 4.2rem;
		height: 1.3rem;
	...
	.three .box-group3 {
		background:
			url('https://zhangcg.oss-cn-beijing.aliyuncs.com/group/iamge2.jpg')
			no-repeat;
		background-size: 100%;
		width: 2.7rem;
		height: 3.98rem;
	...
	.three .box-group4 {
		background:
			url('http://wx2.sinaimg.cn/mw690/007bcsg1gy1fy55vg3e7pj305i0883yi.jpg')
			no-repeat;
		background-size: 100%;
		width: 3.5rem;
		height: 5.22rem;
	...
	.three .box-group5 {
		background:
			url('https://zhangcg.oss-cn-beijing.aliyuncs.com/group/iamge3.jpg')
			no-repeat;
		background-size: 100%;
		width: 2.65rem;
		height: 4.54rem;
	...
	.cen {
		...
		width: 100%;
		height: 100%;
		background: url("http://i1.fuimg.com/671218/bce885c694822ac0.png")
			no-repeat top #666;
		top: 0;
		z-index: 2;
		opacity: 0.6;
